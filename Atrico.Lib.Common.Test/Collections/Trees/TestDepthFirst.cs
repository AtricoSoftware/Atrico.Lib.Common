...
{
    [TestFixture]
    public class TestDepthFirst : TreeTestFixtureBase
    {
        [Test]
        public void TestEmpty()
        {
            ...
            // Act
            tree.DepthFirst(el => list.Add(el.ToString()));
        ...
        public void TestFromRoot()
        {
            ...
            // Act
            tree.DepthFirst(el => list.Add(el.Data.ToString()));
        ...
        public void TestFromMid()
        {
            ...
            // Act
            node12.DepthFirst(el => list.Add(el.Data.ToString()));
    ...
    [TestFixture]
    public class TestDepthFirstT : TreeTestFixtureBase
    {
        [Test]
        public void TestEmpty()
        {
